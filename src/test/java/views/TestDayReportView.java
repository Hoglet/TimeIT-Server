...
public class TestDayReportView
{
	...
	{
		DayReportView view = new DayReportView(emf, pointInMonth, user, user, null);
	...
	{
		DayReportView view = new DayReportView(emf, now, user, user, null);
		String expected = "<button type='button' disabled='disabled'>&gt;&gt;</button>";
		String actual = view.getNextDayLink();

		Assert.assertEquals(expected, actual);
		view = new DayReportView(emf, pointInMonth, user, user, null);
	...
	public final void testCellClass() throws SQLException
	{
		...
		view = new DayReportView(emf, pointInMonth.plusDays(1), user, user, null);
		actual = view.getCellClass(16, 0);
		expected = "";
		Assert.assertEquals(expected, actual);
