...
public class ReportView extends BaseView
{
	...
	protected ZonedDateTime         pointInTime;
	...
	public void extractTimeDescriptors(ZonedDateTime start, ZonedDateTime stop)
	{
	...
	public void extractTasks()
	{
		...
		{
			if (time.getDuration().compareTo(Duration.ofSeconds(0)) > 0)
			{
	...
	public String tabs(int id)
	{
		...
		int month = pointInTime.getMonthValue();
